...
export default async function Video({ params }: PageProps) {
    ...
    if (data.status !== 200) {
        ...
        url: `https://hijabtobrutcolmek.pages.dev/v/${file.file_code}#${file.file_title}`,
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://hijabtobrutcolmek.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://hijabtobrutcolmek.pages.dev'
              }
        }
        const jsonLd2 = {
        '@context': 'https://schema.org',
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://hijabtobrutcolmek.pages.dev/v/${file.file_code}#${file.file_title}`
            }  
        }
        }
...
<meta itemProp="uploadDate" content={`${new Date(
   ...
   /><Script strategy="lazyOnload" data-cfasync="false" async src="https://poweredby.jads.co/js/jads.js"/><ins id="1078976" data-width="300" data-height="100"></ins></center><br></br>
